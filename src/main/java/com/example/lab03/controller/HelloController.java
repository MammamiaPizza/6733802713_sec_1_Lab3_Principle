 ...
 *
 * TODO: แก้ไขข้อมูลส่วนตัวด้านล่างให้เป็นของคุณ - NAME : ชื่อ-สกุล ของนักศึกษา
 * - ID : รหัสนักศึกษา - SECTION : หมายเลขกลุ่ม (Section)
 */
...
public class HelloController {
	...
	private static final String NAME = "ธนภูมิ แทนทุมมา"; // TODO: ใส่ชื่อจริง
	private static final String ID = "673380271-3"; // TODO: ใส่รหัสนักศึกษา
	...
	@GetMapping("/hello")
	public String hello() {
		return String.format("Hello! My name is %s, Student ID: %s, sec: %s", NAME, ID, SECTION);
	}
	...
	@GetMapping("/info")
	public String info() {
		return String.format("Project: Lab03 Spring Boot | Name: %s | ID: %s | Section: %s", NAME, ID, SECTION);
	}

	/**
	 * GET /api/status
	 *
	 * endpoint ตรวจสอบว่าแอปทำงานอยู่ ทดสอบ: http://localhost:8080/api/status
	 */
	@GetMapping("/status")
